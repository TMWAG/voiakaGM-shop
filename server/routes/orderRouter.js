...
router.get("/user/:userId", authMiddleware, orderController.getAllByUserId);
router.get(
  "/status/:statusId",
  checkRoleMiddleware(process.env.MODERATOR_ROLE_ID),
...
router.get("/current", authMiddleware, orderController.getCurrentOrderByUserId);
...
router.put("/add_address", authMiddleware, orderController.addUserAddressById);
router.put(
  "/approved",
  authMiddleware,
  orderController.changeStatusToApprovedById
);
router.put("/paid", authMiddleware, orderController.changeStatusToPaidById);
router.put(
  "/completed",
  authMiddleware,
